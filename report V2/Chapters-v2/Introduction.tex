...
\begin{itemize}
	\item If a product is chosen for the assortment, then all the facings of the product have to be filled fully. This restriction was especially important since dealing with variable sized number of products per facing makes the problem more complex.
