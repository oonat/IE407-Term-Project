...
For the second case, we are relaxing constraints a bit more. As a result of increasing shelf width even more, our new profit is z, even t more than the first case.

What we can say about our basic variables is \dots

Do we need to compare even more?