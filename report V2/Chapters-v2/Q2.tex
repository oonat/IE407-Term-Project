...
\\
According to results from opensolver supermarket gained:\\
...
\\
Products 5,9,10,12,14,15,25 that has highest amount of $\beta_i$ (0.8-0.9) had most number of facings(3-4) and made most money for the supermarket. Products 18 and 24 also had high $\beta_i$ values but they weren't either selected for the assortment or only had 1 facing because their coefficient for demand ($b_i$) were much lower than others. Also all of these products were in shelves 2,3 and 4 which has higher $\gamma_k$ values than shelves 1 and 5\\
\\
